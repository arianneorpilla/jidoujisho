...
class _StringsEn implements BaseTranslations<AppLocale, _StringsEn> {
  ...
  String get error_chatgpt_response =>
      'Failed to get a response. Request rate-limited or denied.';
  String get error_chatgpt_expired =>
      'Login token has expired. Please login again or solve a challenge.';
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'info_standard_model':
        return 'Standard model added';
      case 'info_standard_model_content':
        return '『jidoujisho Yuuna』 has been added to AnkiDroid as a new card type.\n\nSetups making use of a different card type or field order may be used by adding a new export profile.';
      ...
      case 'player_option_definition_focus':
        return 'Definition Focus Mode';
      case 'player_option_subtitle_focus':
        return 'Subtitle Focus Mode';
      ...
      case 'login':
        return 'Login';
      case 'access_token_missing_expired':
        return 'Login token missing or expired';
      case 'send':
        return 'Send';
      case 'no_messages':
        return 'Start a chat';
      ...
      case 'error_chatgpt_response':
        return 'Failed to get a response. Request rate-limited or denied.';
      case 'error_chatgpt_expired':
        return 'Login token has expired. Please login again or solve a challenge.';
      case 'pick_file':
        return 'Pick File';
      case 'open_url':
        return 'Open URL';
