...
class JidoujishoLocalisations {
  ...
  static const Map<String, String> english = {
    ...
    'search_label_before': 'Show all ',
    'search_label_after': 'results found for',
    ...
    'record': 'Record',
    'stop': 'Stop',
    'no_audio_file': 'No audio file to save.',
    ...
    'extend_page_beyond_navbar': 'Extend page beyond navigation bar',
    'tweaks': 'Tweaks',
    'increase': 'Increase',
    'decrease': 'Decrease',
