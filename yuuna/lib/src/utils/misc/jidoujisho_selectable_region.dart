...
/// with a [JidoujishoSelectableRegion] widget enables selection within that subtree (for
...
///
/// A [JidoujishoSelectableRegion] widget requires configuration; in particular specific
/// [selectionControls] must be provided.
///
/// The [SelectionArea] widget from the material library configures a
/// [JidoujishoSelectableRegion] in a platform-specific manner (e.g. using a Material
/// toolbar on Android, a Cupertino toolbar on iOS), and it may therefore be
/// simpler to use that widget rather than using [JidoujishoSelectableRegion] directly.
///
/// ## An overview of the selection system.
///
/// Every [Selectable] under the [JidoujishoSelectableRegion] can be selected. They form a
/// selection tree structure to handle the selection.
///
/// The [JidoujishoSelectableRegion] is a wrapper over [SelectionContainer]. It listens to
...
///
/// The [SelectionContainer] created by [JidoujishoSelectableRegion] is the root node of a
...
/// ```dart
/// MaterialApp(
///   home: JidoujishoSelectableRegion(
...
/// a [JidoujishoSelectableRegion], consider wrapping that group of widgets using
...
/// wrap part of the subtree with another [JidoujishoSelectableRegion]. The selection of the
...
///
/// See also:
///  * [SelectionArea], which creates a [JidoujishoSelectableRegion] with
...
class JidoujishoSelectableRegion extends StatefulWidget {
  /// Create a new [JidoujishoSelectableRegion] widget.
  ///
  /// The [selectionControls] are used for building the selection handles and
  /// toolbar for mobile devices.
  const JidoujishoSelectableRegion({
  ...
  ///
  /// By default, [JidoujishoSelectableRegion]'s [TextMagnifierConfiguration] is disabled.
  ///
  ...
  final JidoujishoSelectableRegionContextMenuBuilder? contextMenuBuilder;

  /// Reports a new selection and gives the current offset of the tapped area
  /// as well as the index position.
  final void Function(
    Offset globalPosition,
    int index,
    Function(TextRange) updatePosition,
  ) onSelect;

  /// Executes a function on clear.
  ...
  ///
  /// For example, [JidoujishoSelectableRegion] uses this to generate the default buttons
  /// for its context menu.
  ///
  /// See also:
  ///
  /// * [JidoujishoSelectableRegionState.contextMenuButtonItems], which gives the
  ///   [ContextMenuButtonItem]s for a specific JidoujishoSelectableRegion.
  ...
  @override
  State<StatefulWidget> createState() => JidoujishoSelectableRegionState();
}

/// State for a [JidoujishoSelectableRegion].
class JidoujishoSelectableRegionState extends State<JidoujishoSelectableRegion>
  ...
  final _JidoujishoSelectableRegionContainerDelegate _selectionDelegate =
      _JidoujishoSelectableRegionContainerDelegate();
  ...
  void initState() {
    ...
    _gestureRecognizers[TapGestureRecognizer] =
      ...
      (TapGestureRecognizer instance) {
        instance.onTapDown = _handleTouchTapDown;
  ...
  @override
  void didUpdateWidget(JidoujishoSelectableRegion oldWidget) {
  ...
  void _handleTouchTapDown(TapDownDetails details) {
    widget.focusNode.requestFocus();
  ...
  void _selectWordAt({required Offset offset}) {
    ...
    widget.onSelect(
      offset,
      _selectionDelegate.currentSelectionStartIndex,
      (range) {
        _selectionDelegate.currentSelectionStartIndex = range.start;
        _selectionDelegate.currentSelectionEndIndex = range.end;
        _selectionDelegate._updateLastEdgeEventsFromGeometries;
      },
    );
  }
  ...
  /// See also:
  ///
  /// * [JidoujishoSelectableRegion.getSelectableButtonItems], which performs a similar role,
  ///   but for any selectable text, not just specifically JidoujishoSelectableRegion.
  ...
  List<ContextMenuButtonItem> get contextMenuButtonItems {
    return JidoujishoSelectableRegion.getSelectableButtonItems(
  ...
  void bringIntoView(TextPosition position) {
    /* JidoujishoSelectableRegion must be in view at this point. */
  }
  ...
  void userUpdateTextEditingValue(
    ...
    /* JidoujishoSelectableRegion maintains its own state */
  }
...
class _SelectAllAction extends _NonOverrideAction<SelectAllTextIntent> {
  ...
  final JidoujishoSelectableRegionState state;
...
class _JidoujishoSelectableRegionContainerDelegate
...
abstract class MultiSelectableSelectionContainerDelegate
  ...
  static int _compareVertically(Rect a, Rect b) {
    if ((a.top - b.top < precisionErrorTolerance &&
            a.bottom - b.bottom > -precisionErrorTolerance) ||
        (b.top - a.top < precisionErrorTolerance &&
            b.bottom - a.bottom > -precisionErrorTolerance)) {
      return 0;
    }
...
/// [JidoujishoSelectableRegionState].
///
/// See also:
///
///  * [EditableTextContextMenuBuilder], which performs the same role for
///    [EditableText].
typedef JidoujishoSelectableRegionContextMenuBuilder = Widget Function(
  BuildContext context,
  JidoujishoSelectableRegionState JidoujishoSelectableRegionState,
);
