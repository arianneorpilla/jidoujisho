...
Future<List<Video>> searchYouTubeTrendingVideos() {
  YoutubeExplode yt = YoutubeExplode();
  // LOCALIZATION
  return yt.playlists.getVideos("PLmtapKaZsgZsjfcjrumAR4KVu5LDDeugN").toList();
}
...
Future<bool> checkYouTubeClosedCaptionAvailable(String videoID) async {
  ...
  String httpSubs = await http.read(
      Uri.parse("https://www.youtube.com/api/timedtext?lang=ko&v=" + videoID));
