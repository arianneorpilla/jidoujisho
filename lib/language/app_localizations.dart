class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    ...
    'Tagalog': {
      ...
      'player_optdion_select_audio': 'Pumili ng Audio Track',
      ...
      'deck_label_after': '.',
      'image_label_before': 'Pinipili ang ',
      'image_label_middle': 'mula sa ',
      'image_label_after': '',
      ...
      'ankidroid_api': 'AnkiDroid API',
      'ankidroid_api_message':
          'Kailangan na buhay ang AnkiDroid API upang gamitin ang Panggawa ng Card. Buksan ang AnkiDroid upang magpatuloy.',
