...
class AudioMessage {
  ...
  // ignore: unused_element
  static AudioMessage _fromMap(Map<dynamic, dynamic> pigeonMap) {
    if (pigeonMap == null){
      return null;
    }
...
class VideoPlayerApi {
  ...
  Future<AudioMessage> getAudios(TextureMessage arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel =
        BasicMessageChannel<dynamic>('dev.flutter.pigeon.VideoPlayerApi.getAudios', StandardMessageCodec());
    ...
    if (replyMap == null) {
      ...
      return AudioMessage._fromMap(replyMap['result']);
    }
